...
import GestorPartidas from './components/GestorPartidas';
import { IGestorPartidasProps } from './components/IGestorPartidasProps';
...
export default class GestorPartidasWebPart extends BaseClientSideWebPart<IGestorPartidasWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGestorPartidasProps> = React.createElement(
      GestorPartidas,
      {
