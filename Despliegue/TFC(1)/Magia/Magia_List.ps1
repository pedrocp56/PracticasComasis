...
$listTitle = "Lista_MagiaInfo"
$listDescription = "Lista Magia Informacion"
$listTemplate = 100

#añadir tipos de contenido
$tipodecontenido = "MagiaInfo"
...
if ($vista) {
        ...
        $context.ExecuteQuery();
        $view.ViewFields.Add("Magia_Cantidad");
        $view.ViewFields.Add("Magia_Hechizos");
        $view.ViewFields.Add("Magia_Recuperacion");
