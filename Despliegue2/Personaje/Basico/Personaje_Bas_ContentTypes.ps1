$contentTypeGroup = "PersonajeInformacion";
$contentTypeName = "PersonajeInfoBas";

#Añadir los internal names de las columnas que compondrán el tipo de contenido
$columns = "Personaje_Usuario","Personaje_Nombre","Personaje_Clase","Personaje_Nivel","Personaje_Raza","Personaje_Alinamiento","Personaje_Estado", "Personaje_Inspiracion", 
